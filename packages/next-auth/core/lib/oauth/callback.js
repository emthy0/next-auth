...
async function oAuthCallback(params) {
  ...
  try {
    ...
    if ((_provider$token2 = provider.token) !== null && _provider$token2 !== void 0 && _provider$token2.request) {
      ...
      var _provider$authorizati, _provider$authorizati2, _provider$authorizati3, _provider$authorizati4, _provider$authorizati5, _provider$authorizati6;

      provider.callbackUrl = (_provider$authorizati = provider === null || provider === void 0 ? void 0 : (_provider$authorizati2 = provider.authorization) === null || _provider$authorizati2 === void 0 ? void 0 : (_provider$authorizati3 = _provider$authorizati2.params) === null || _provider$authorizati3 === void 0 ? void 0 : _provider$authorizati3.redirect_uri) !== null && _provider$authorizati !== void 0 ? _provider$authorizati : provider.callbackUrl;
      provider.signinUrl = (_provider$authorizati4 = provider === null || provider === void 0 ? void 0 : (_provider$authorizati5 = provider.authorization) === null || _provider$authorizati5 === void 0 ? void 0 : (_provider$authorizati6 = _provider$authorizati5.params) === null || _provider$authorizati6 === void 0 ? void 0 : _provider$authorizati6.redirect_uri) !== null && _provider$authorizati4 !== void 0 ? _provider$authorizati4 : provider.signinUrl;
